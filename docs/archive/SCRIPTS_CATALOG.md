...
**Archivado.** Doc canónico actual: [../SCRIPTS.md](../SCRIPTS.md).
...
**Legacy / deprecated:** scripts que se mantienen por compatibilidad o uso puntual pero no forman parte del flujo oficial. Ver `docs/RUNBOOK_SCRIPTS.md` por prefijo.
